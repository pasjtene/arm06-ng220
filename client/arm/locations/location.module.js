...
var LocationModule = (function () {
    ...
    LocationModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [
                list_locations_comp_1.ListLocationsComponent,
                list_locations_comp_1.ConfirmLogout,
                list_locations_comp_1.SettingsDialog,
                list_locations_comp_1.ConfirmDeleteDialog
            ],
            entryComponents: [
                list_locations_comp_1.ListLocationsComponent,
                list_locations_comp_1.ConfirmLogout,
