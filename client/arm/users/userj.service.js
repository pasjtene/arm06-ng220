...
var UserjService = (function () {
    function UserjService(http) {
        this.http = http;
        this.assetToDelete = {};
    ...
    UserjService.prototype.create = function (asset) {
    ...
    UserjService.prototype.delete = function (asset) {
    ...
    UserjService.prototype.getAssets = function () {
    ...
    UserjService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http])
    ], UserjService);
    return UserjService;
}());
exports.UserjService = UserjService;
//# sourceMappingURL=userj.service.js.map